                  ...
                  child: DefaultTextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Secondary nature: ${state.playerSecondaryNature}',
                        ),
                        Text(
                          'Player jutsu: ${state.playerJutsuNames.join(', ')}',
                        ),
                        Text(
                          'Chakra: ${state.currentChakra}/${state.maxChakra}',
                        ),
                        Wrap(
                          spacing: 6,
                          children: state.practiceJutsus.map((jutsu) {
                            return OutlinedButton(
                              onPressed: state.currentChakra >= jutsu.cost
                                  ? () => widget.onPracticeJutsu(jutsu.id)
                                  : null,
                              child: Text(
